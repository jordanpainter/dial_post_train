...
CONFIG="$REPO/configs/llama/sft-llama-cpt.json"
...
mkdir -p \
  ...
  "$SCRATCH/cache/sft-llama-cpt" \
  "$SCRATCH/models/sft-llama-cpt"
...
export WANDB_PROJECT="sft-llama-cpt"
export WANDB_NAME="sft-llama-cpt-$(date +%Y%m%d-%H%M%S)"
