...
CONFIG="$REPO/configs/qwen/sft-qwen-cpt.json"
...
mkdir -p \
  ...
  "$SCRATCH/cache/sft-qwen-cpt" \
  "$SCRATCH/models/sft-qwen-cpt"
...
export WANDB_PROJECT="sft-qwen-cpt"
export WANDB_NAME="sft-qwen-cpt-$(date +%Y%m%d-%H%M%S)"
